...
LABEL description="Default container definition for class competition. Based on https://parsertongue.org/tutorials/using-the-ua-hpc/#constructing-a-docker-image"
